      ...
      flex items-center justify-between bg-white shadow-md">
        ...
        <nav className="flex items-center space-x-6">
          <button
            ...
            className="text-[#4E5968] text-sm lg:text-base font-bold
            bg-[#F2F4F6] px-3 md:px-4 py-2 rounded-md cursor-pointer
            hover:text-gray-800 hover:bg-[#E5E7EB] transition-colors">
            의뢰하기
          </button>
        </nav>
      </header>
