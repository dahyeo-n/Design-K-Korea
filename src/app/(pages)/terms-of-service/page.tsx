const TermsOfService = () => {
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-[#212529]">
      <h1 className="text-2xl sm:text-3xl font-bold mb-10">이용약관</h1>
      ...
      <div className="space-y-10 leading-relaxed text-sm sm:text-base">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제3조 약관 외 준칙</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제4조 이용계약 체결</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제5조 서비스 이용 신청</h2>
          <ol className="list-decimal pl-6 space-y-1">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제6조 개인정보처리방침</h2>
          <ol className="list-decimal pl-6 space-y-1">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제7조 운영자의 의무</h2>
          <ol className="list-decimal pl-6 space-y-1">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제8조 회원의 의무</h2>
          <ol className="list-decimal pl-6 space-y-1">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제9조 서비스 이용 시간</h2>
          <ol className="list-decimal pl-6 space-y-1">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제12조 게시물의 관리</h2>
          <ol className="list-decimal pl-6 space-y-1">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제13조 게시물의 보관</h2>
          <p className="mb-2">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제15조 손해배상</h2>
          <ol className="list-decimal pl-6 space-y-1">
            <li>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-2">제16조 면책</h2>
          <ol className="list-decimal pl-6 space-y-1">
            <li>
